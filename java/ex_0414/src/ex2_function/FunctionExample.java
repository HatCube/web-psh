...
//람다식의 합성 : 여러 함수를 하나의 함수처럼 연결해서 새로운 함수를 만든다
...
//		Consumer<String> split = x -> x.replace(" ", "");
//		Consumer<String> lower = x -> x.toLowerCase();
//		Consumer<String> jupdu = x -> System.out.println("user_" + x);
//		
//		Consumer<String> result4 = split.andThen(lower).andThen(jupdu);
//		System.out.println("아무 문자열 입력 : ");
//		result4.accept(sc.nextLine());
