...
//NullPointerException : 참조변수가 null인 상태에서 필드나 메서드에 접근할 경우 발생하는 예외
public class ExceptionHandlingExample1 {
	//문자열 데이터를 전달받아서 문자열의 길이가 얼마인지 출력하는 메서드 작성하기
	public static void printLength(String words) {
		 try {
			 //예외가 발생할 수도 있고,아닐 수도 있음
			 System.out.println("문자열의 길이 : " + words.length());
			...
			//e.printStackTrace(); 예외가 어디서 발생했는지 추적한 내용까지 출력 해준다
