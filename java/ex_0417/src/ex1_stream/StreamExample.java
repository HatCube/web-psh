...
public class StreamExample {
	public static void main(String[] args) {
		...
		//그렇게 때문에 stream()메서드가 존재하지는 않는다.
		
		//keySet()
		//key만 스트림으로 만들고 싶을때 사용
...
//		fruits[0] = "사과";
		...
		//기본타입(int,double,long등)은 일반 Stream이 아니라 전용 스트림을 사용한다.
		//일반 스트림을 쓰게되면 int > Integer처럼 변환되는 작업을 거쳐야 하기 때문에 
		//성능 저하가 발생할 수 있다.
