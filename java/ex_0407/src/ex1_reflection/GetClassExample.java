...
public class GetClassExample {
	public static void main(String[] args) throws Exception{
		...
		// getPackageName() : 패키지 정보 읽기
		System.out.println("패키지 : " + clazz.getPackageName()); // 패키지 : ex1_reflection
		
		// getSimpleName() : 패키지를 제외한 클래스 이름
		System.out.println("클래스 간단 이름 : " + clazz.getSimpleName()); // 클래스 간단 이름 : Car
		
		// getName() : 패키지를 포함한 전체 클래스명
		System.out.println("클래스 전체 이름 : " + clazz.getName()); // 클래스 전체 이름 : ex1_reflection.Car
